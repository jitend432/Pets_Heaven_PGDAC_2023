            ...
            <Card sx={{ maxWidth: 450 }} elevation={3}>
              <CardActionArea>
                ...
                <CardContent>
                  ...
                  <Typography variant="body1" color="text.secondary">
                    We have successfully introduced and implemented this therapy
                    for mentally challenged children,autistic children,
                    hyperactive children, physically disabled people, children
                    with hearing and speech impairment, children with
                    developmental disability, Cancer patients, AIDS orphans,
                    children with learning disabilities, and People with
